...
-----------
- [Umweltanalutik](umweltanalytic/README.md)
- [Git cheatsheets](git/cheatsheets.md)

## Entwiecklungprocess und Ablaufeptemierung

[RFC-Process Skitzze und Infos](rfc/rfc.md)
[Summary](motivation.md)
[Motivation](zusammenfassung.md)
